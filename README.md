...
- **SMA(P)-SMA(P) cable**
- **4inch Screen:** Waveshare 4inch RPi LCD [Waveshare](https://www.waveshare.com/4inch-rpi-lcd-a.htm)
...
4. Open a terminal
5. Launch the next command lines
...
## How to use Easy GNSS
  See the User Guide [here](doc/UserGuideEasyGNSS.pdf)

Based on the installation guide of [TouchRTKStation](https://github.com/taroz/TouchRTKStation).
